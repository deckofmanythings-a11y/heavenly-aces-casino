...
var INSTRUCTIONS_DATA = {
  ...
  djwild: { title: '🃏 DJ Wild Stud Poker', pages: [
    ...
    { heading:'Trips', body:
      '<h3><span class="bet-name">Trips</span> (optional side bet)</h3>'
      +'<p>Pays on your own hand regardless of the dealer or a fold. A hand is <b>Natural</b> only when no wild card is used to make it (an unused deuce still counts as natural) — natural hands pay far more. You get whichever reading, natural or wild, is higher:</p>'
      +'<table style="width:100%;border-collapse:collapse;font-size:14px">'
      +'<tr style="color:#ffe066"><th style="text-align:left">Hand</th><th style="text-align:right">Natural</th><th style="text-align:right">With Wild</th></tr>'
      +'<tr><td>Five Wilds</td><td style="text-align:right">—</td><td style="text-align:right"><span class="odds">2,000:1</span></td></tr>'
      +'<tr><td>Royal Flush</td><td style="text-align:right"><span class="odds">1,000:1</span></td><td style="text-align:right"><span class="odds">100:1</span></td></tr>'
      +'<tr><td>Five of a Kind</td><td style="text-align:right">—</td><td style="text-align:right"><span class="odds">100:1</span></td></tr>'
      +'<tr><td>Straight Flush</td><td style="text-align:right"><span class="odds">200:1</span></td><td style="text-align:right"><span class="odds">30:1</span></td></tr>'
      +'<tr><td>Four of a Kind</td><td style="text-align:right"><span class="odds">90:1</span></td><td style="text-align:right"><span class="odds">6:1</span></td></tr>'
      +'<tr><td>Full House</td><td style="text-align:right"><span class="odds">40:1</span></td><td style="text-align:right"><span class="odds">5:1</span></td></tr>'
      +'<tr><td>Flush</td><td style="text-align:right"><span class="odds">25:1</span></td><td style="text-align:right"><span class="odds">4:1</span></td></tr>'
      +'<tr><td>Straight</td><td style="text-align:right"><span class="odds">20:1</span></td><td style="text-align:right"><span class="odds">3:1</span></td></tr>'
      +'<tr><td>Three of a Kind</td><td style="text-align:right"><span class="odds">6:1</span></td><td style="text-align:right"><span class="odds">1:1</span></td></tr>'
      +'</table>'
    },
    { heading:'Two-Way Bad Beat & The Light', body:
      '<h3><span class="bet-name">Two-Way Bad Beat</span> (optional side bet)</h3>'
      +'<p>Wins when <b>both</b> you and the dealer make three of a kind or better and you don\'t tie. It pays on the <b>lower (beaten) hand</b> — whether that hand is yours or the dealer\'s. A tie loses; it stays in action even if you fold.</p>'
      +'<ul>'
      +'<li>Royal Flush / Five of a Kind / Straight Flush / Four of a Kind — <span class="odds">299:1</span></li>'
      +'<li>Full House — <span class="odds">200:1</span></li>'
      +'<li>Flush — <span class="odds">100:1</span></li>'
      +'<li>Straight — <span class="odds">50:1</span></li>'
      +'<li>Three of a Kind — <span class="odds">15:1</span></li>'
      +'</ul>'
      +'<h3><span class="bet-name">The Light</span> (progressive jackpot)</h3>'
